...
UPLOAD_SPEED := $(if $(UPLOAD_SPEED),$(UPLOAD_SPEED),57600)
...
ESPTOOL ?= /workspace/libraries/esp8266com/esp8266/tools/esptool/esptool.py
ESPTOOL_ARGS ?= --before no_reset --after no_reset --no-stub
...
ifneq ($(ESPTOOL),)
  ...
  ifeq ($(CHIP),esp8266)
    ESPTOOL_COM = $(ESPTOOL)
    UPLOAD_COM = $(ESPTOOL_PATTERN) write_flash 0x00000 $(BUILD_DIR)/$(MAIN_NAME).bin
    FS_UPLOAD_COM = $(ESPTOOL_PATTERN) write_flash $(SPIFFS_START) $(FS_IMAGE)
  endif
endif
...
upload flash: all
	...
	#$(UPLOAD_COM)
	$(ESPTOOL) $(ESPTOOL_ARGS)  --baud=$(UPLOAD_SPEED) --port $(UPLOAD_PORT) write_flash 0x00000 $(BUILD_DIR)/$(MAIN_NAME).bin
...
restore_flash:
	...
	$(ESPTOOL_PATTERN) write_flash 0 $(FLASH_FILE)
